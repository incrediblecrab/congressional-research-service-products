...
COLUMN_DOCS = {
    ...
    "text_url": "The URL the text was extracted from",
...
def render(manifest):
    ...
    lines += [
        ...
        "- `text` is the PDF's text layer, so it keeps line breaks, page headers and footers, and has no figures or table structure. Products without a PDF fall back to the HTML rendition.",
